...
(function() {
  ...
  Game_CharacterBase.prototype.initMembers = function() {
    ...
    this._dashCount = 0;
    this._friction = 0.5;
    this._moveSpeed = 0.25;
    this._jumpSpeed = 0.55;
  ...
  Game_Player.prototype.refresh = function() {
    ...
    if (actor) {
      ...
      this._moveSpeed     = actor.loadTagParam('move_speed',    0.25);
      this._jumpSpeed     = actor.loadTagParam('jump_speed',    0.55);
      ...
      this._gravity       = actor.loadTagParam('gravity',       0.03);
